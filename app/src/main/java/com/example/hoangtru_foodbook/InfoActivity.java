...
public class InfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SpannableString bestBefore = new SpannableString(bestBeforeView.getText() + food.getBestBefore().toString());
        SpannableString location = new SpannableString(locationView.getText() + food.getLocation().toString());
